...
var treeMenu = [
	{ level:1, name:"用户管理"},
	{ level:2, name:"用户列表", ico:"images/icon_default.gif",link:"students/Students_query.action"},
	{ level:1, name:"数据管理"},
	{ level:2, name:"书籍列表", ico:"images/icon_default.gif",link:"books/Books_query.action"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"推荐管理", ico:"images/icon_default.gif",link:"recomended/Recomended_query.action"},
	{ level:2, name:"订单管理", ico:"images/icon_default.gif",link:"orders/Orders_query.action"},
